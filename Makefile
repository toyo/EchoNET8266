...
#LIBS = stdc++ c gcc hal phy pp net80211 lwip wpa main 
LIBS = gcc hal phy pp net80211 lwip wpa main crypto
#

# compiler flags using during compilation of source files
CCCFLAGS = -Os -Wpointer-arith -Wundef -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals -mno-serialize-volatile -D__ets__ -DICACHE_FLASH
CFLAGS = $(CCCFLAGS) -std=gnu90 
CXXFLAGS	= $(CCCFLAGS) -fno-rtti -fno-exceptions -std=c++0x
